...
class Substructure:
    ...
    def perform_calculations(self, sat_i):
        ...
        if  idx_zp99 > 0:
            #forwards from idx_zp99
             timetot, Nstep, tmax, pos_vel, min_loc, max_loc, satdist, t, half_period_locs, rosette_angle, rosette_angle_fit, all_apo, all_peri, ca, cp, tba, vels_peri, vels_apo = integrate_orbit_wrapper(self,coord1[sat_i], dekel_host_coords_at,mod_mass_at, idx_zp99, time_between_apocenters[sat_i], ecc_est_zp99)
    ...
    def handle_mc_files(self, sat_i, real_zp99, pericenter_locs_hold, apocenter_locs_hold, idx_mass_res_hold, idx_zp99_hold, entered, entered_zp99, peri_num, Norb_z0, Norb_zp99):
        ...
        if all(os.path.exists(path) for path in paths):
            ...
            ca_mc, cp_mc, vels_peri_mc, vels_apo_mc, satdist_mc, t_mc, tba_mc, host_total_profile, pos_vel = monte_carlo_orbits.integrate_mc_orbits(
        ...
        if real_zp99:
            ...
            if all(os.path.exists(path) for path in paths_zp99):
                ...
                ca_mc_zp99, cp_mc_zp99, vels_peri_mc_zp99, vels_apo_mc_zp99, satdist_mc_zp99, t_mc_zp99, tba_mc_zp99, host_total_profile_zp99, pos_vel_zp99 = monte_carlo_orbits.integrate_mc_orbits(
